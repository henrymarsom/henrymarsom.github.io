...
<div class="resume-container">
  ...
  <div class="resume-inner">
    ...
    <div class="resume-header">
      ...
      <a class="resume-download-top" href="{{ site.baseurl }}/assets/Resumée.pdf" target="_blank" aria-label="Download Resume">
...
<!-- Resume Image -->
    <section class="resume-image">
      <img src="{{ site.baseurl }}/assets/Resumée.pdf" alt="Resume of Henry Marsom" class="resume-img">
    </section>
  </div>
